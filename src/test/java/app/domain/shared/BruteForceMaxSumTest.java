...
public class BruteForceMaxSumTest {

    @Test
    public void Max() {
        int[] array = {-2, 1, -3, 4, -1, 2, 1, -5, 4};
        int[] expected = {4, -1, 2, 1};
        Assert.assertArrayEquals(expected, BruteForceMaxSum.max(array));
    }
    ...
    public void y() {
        ...
        int[] expected = {63, 77, 77};
        Assert.assertArrayEquals(expected,BruteForceMaxSum.max(a));
    }
}