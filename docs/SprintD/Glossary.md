...
| **Alphanumeric Character** | **Caracter Alfanumérico** | It's a system that consists of letters, numbers and some other conventional symbols. |
...
| **Chemical Analysis** | **Análises Químicas** | Chemical analysis is the study of the chemical composition and structure of substances. |
...
| **Diagnosis** | **Diagnóstico** | The detection of the origin of problems such as diseases by examining the symptoms. |
...
| **Lab Order** | **Receita Médica** | A lab order is prescribed by a doctor, and contains the type of test and the parameters that are going to be evaluated. |
