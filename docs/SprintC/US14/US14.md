...
- *There is a dependency to "US12 As a clinical chemistry technologist, I intend to record the results of a given test"
  since at least the results of the given test needs to exist.*
