...
**AC2:** The clinical chemistry technologist should use the sample barcode number to find the test for which the sample was collected

**AC3:** The reference values should be presented both to the clinical chemistry technologist (US12) and to the specialist doctor (US14)
